...
""" SAMPLE CONFIG
{
  ...
  "api_key": "xkeysib-xxxxxxxxxxxxxxxxxxxxxx",
...
def send(notification_id):
    ...
    base_url = md.get("api_base_url", "https://api.brevo.com/v3").rstrip("/")
    endpoint = f"{base_url}/smtp/email"
    headers = {
        "api-key": md.get("api_key"),
        "Content-Type": "application/json",
        "accept": "application/json",
    }

    payload = {
        "sender": {"email": from_email, "name": md.get("from_name", "")},
