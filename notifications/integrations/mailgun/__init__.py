...
# Mailgun red "MG" badge.
LOGO = (
    '<svg viewBox="0 0 24 24" width="24" height="24" xmlns="http://www.w3.org/2000/svg">'
    '<rect width="24" height="24" rx="5" fill="#E0342A"/>'
    '<text x="12" y="16" text-anchor="middle" font-family="Arial,Helvetica,sans-serif" '
    'font-size="9" font-weight="700" fill="#ffffff">MG</text></svg>'
)
...
MANIFEST = {
    ...
    "description": "Sends email through the Mailgun Messages HTTP API.",
    "brand_color": "#E0342A",
    "logo": LOGO,
    "config_fields": [
        ...
        {"name": "domain", "label": "Sending Domain", "type": "host", "required": True,
